...
// Per-cluster Open Graph share images, generated by `pnpm og:generate`
// (keys must match the CLUSTERS list in apps/web/scripts/generate-og.mjs).
const CLUSTER_OG_IMAGE: Record<string, string> = {
  "Connaissance TDAH": "/og/connaissance-tdah.png",
  "Guide de gestion Barkley": "/og/gestion-barkley.png",
  "Ressources pour les parents": "/og/parents.png",
  "Parcours de soin en France": "/og/parcours-de-soin.png",
  "Ressources pour l'entourage": "/og/entourage.png",
};

/** Share-preview image for an article, picked from its topic cluster. */
export function getArticleOgImage(cluster: string): string {
  const normalized = cluster.replace(/^Pillar · /, "");
  return CLUSTER_OG_IMAGE[normalized] ?? "/og-image.png";
}
