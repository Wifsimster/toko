...
export const step9Content: StepContent = {
    ...
    intro:
        ...
        "This chapter teaches you a systematic analysis method — ABC analysis — to decode any new behavior and respond using the tools you've already mastered. The goal is to become your own expert.",

    understand: {
        heading: "ABC analysis: decoding behavior",
        body:
            "ABC analysis (Antecedent — Behavior — Consequence) is a foundational tool in behavioral psychology. For any problematic behavior, ask yourself three questions. Antecedent: what happened just before? What was the context — the time, the child's emotional state, the request you made?\n\n" +
            "Behavior: what exactly happened? Describe the observable facts, not your interpretation. \"He screamed and threw his notebook\" rather than \"he had a meltdown.\" Consequence: what happened next? How did you react? Did the behavior allow the child to get something (attention, task avoidance, a desired object)?\n\n" +
            "This analysis reveals the function of the behavior. A child who lies to avoid punishment has a different need than a child who lies to get attention. The response will therefore be different. By identifying the hidden \"why\" behind the behavior, you choose the most appropriate tool from your toolbox.",
        callout: {
            type: "tip",
    ...
    scenarios: [
        {
            ...
            body:
                "Mael, age 7, systematically denies any wrongdoing. Your ABC analysis reveals a pattern: when you discover something he did wrong and ask about it in an accusatory tone, Mael lies. When he tells the truth, the punishment is the same as when he lies.\n\n" +
                "He has zero incentive to be honest. You change your approach: you adopt a neutral tone when asking the question, and you clearly differentiate consequences. \"You spilled the juice. Thank you for telling me. Grab the sponge and clean it up, please.\"\n\n" +
                "Versus: \"You lied about the juice. You clean it up AND you lose 5 minutes of screen time.\" Within a few weeks, Mael lies much less — because telling the truth has become less costly.",
        },
        {
            title: "New school year transition",
            body:
                "September is approaching, and Jade, age 8, is increasingly anxious: eye blinking, trouble falling asleep, growing defiance. You anticipate by applying familiar tools. You reinstall school routines a week before classes start (earlier bedtime, gradual wake-ups). You visit the school together to reduce the unknown.\n\n" +
        ...
        },
        {
            ...
            body:
                "For the past few weeks, fights between Theo (age 9) and his little sister Lena (age 6) have been escalating systematically. Your ABC analysis shows that conflicts always happen when both children share a space without a structured activity, and that Theo gets attention (even negative attention) when he bothers Lena.\n\n" +
                "You reorganize: stretches of separate play alternate with supervised joint activities. You massively reinforce cooperative play: \"You've been playing together for 10 minutes without fighting — that's awesome! You each earn a token.\" The conflicts don't disappear, but their frequency drops significantly.",
        },
    ],
