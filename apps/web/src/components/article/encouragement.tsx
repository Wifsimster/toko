...
export function Encouragement({ children }: { children: ReactNode }) {
  return (
    <aside className="my-8 flex items-start gap-3.5 rounded-xl border border-accent-200/60 bg-accent-50 px-5 py-5 dark:border-accent-800/40 dark:bg-accent-900/25">
