...
// The editable fields of the settings row, stripped of the server-managed
...
// One labelled on/off setting, shown as a bordered row with an explicit
// description — the whole row is clickable to toggle the checkbox.
function ToggleRow({
  id,
  label,
  description,
