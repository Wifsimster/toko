...
const makeStyles = (c: Palette) =>
  StyleSheet.create({
    ...
    actionTitle: { color: c.onBrand, fontSize: 17, fontFamily: fonts.semibold },
    actionHint: { color: c.onBrand, opacity: 0.8, fontSize: 13, fontFamily: fonts.body, marginTop: 2 },
    actionChevron: { color: c.onBrand, fontSize: 24 },
